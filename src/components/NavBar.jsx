...
const NavBar = () => {
    ...
    return (
        ...
        <Box w='100%' m = '1' bg='blue.300' color='black' borderRadius= 'md'>
            ...
            <Flex justify='center' align='center'>
                ...
                <Box w='100%' p='3'>
                    <ul>
                        <Button p='3' m='15px' colorScheme='gray'>Inicio</Button>
                        <Menu>
                            <MenuButton p='3' m='15px' colorScheme='gray' as={Button}>Productos</MenuButton>
                            <MenuList>
                        ...
                        <Button p='3' m='15px' colorScheme='gray'>Sobre nosotros</Button>
                        <Button p='3' m='15px' colorScheme='gray'>Contacto</Button>
                    </ul>
                </Box>
                <Spacer />
